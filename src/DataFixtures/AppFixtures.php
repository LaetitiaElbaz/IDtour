...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $poi1->setStreetNumber('2');
        $poi1->setStreetName('Boulevard du Jeu de Ballon');
        ...
        $poi2->setStreetNumber('124');
        $poi2->setStreetName('Chemin du petit mont');
        ...
        $comentPoi2User2 = new Comment();
        $comentPoi2User2->setContent('Les enfants ont adoré!');
        $comentPoi2User2->setPicture('assets/images/Cracovie_Nov2007 021.1.jpg');
        $comentPoi2User2->setRate(5);
        $comentPoi2User2->setPoi($poi2);
        $comentPoi2User2->setUser($user2);
        $manager->persist($comentPoi2User2);
